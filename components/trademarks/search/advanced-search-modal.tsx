  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl min-w-5xl max-h-[90vh] flex flex-col p-0 overflow-hidden">
        <DialogHeader className="px-4 pt-4 pb-4 border-b sticky top-0 bg-white dark:bg-zinc-950 z-10 rounded-t-lg">
        ...
        <DialogFooter className="px-4 pb-4 pt-4 border-t bg-white dark:bg-zinc-950 rounded-b-lg">
          <Button
            variant="outline"
            onClick={() => {
              onOpenChange(false);
